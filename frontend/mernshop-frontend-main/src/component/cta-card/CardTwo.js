    ...
    <div className="w-full bg-white shadow-sm lg:px-10 lg:py-5 p-6 rounded-lg">
      <div className="flex justify-between items-center">
        <div className="lg:w-3/5">
          ...
          <Link
            href="#downloadApp"
            className="lg:w-1/4 text-xs font-serif font-medium inline-block mt-5 px-8 py-3 bg-blue-500 text-center text-white rounded-full hover:text-white hover:bg-blue-600">

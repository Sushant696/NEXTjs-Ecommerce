    ...
    <div className="flex justify-between items-center">
      <div>
        ...
        {t("common:Banner-paragraph-text")}
          <Link href="#discount" className="text-blue-600 ml-1">
      ...
      <Link
        ...
        className="text-sm font-serif font-medium px-6 py-2 bg-blue-500 text-center rounded-full text-white hover:bg-blue-700">

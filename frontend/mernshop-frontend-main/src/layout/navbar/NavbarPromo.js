                ...
                <div className="flex justify-between items-center md:justify-start md:space-x-10">
                  ...
                  >
                    <Popover className="relative font-serif">
                      <Popover.Button className="group inline-flex items-center py-2 hover:text-blue-600 focus:outline-none">
                        <span className="font-serif text-sm font-medium">
                          {t("common:Categories")}
                        </span>
                        <ChevronDownIcon
                          className="ml-1 h-3 w-3 group-hover:text-blue-600"
                          aria-hidden="true"
                        />
                      </Popover.Button>
                    ...
                    <Link href="/about-us">
                      <a className="font-serif mx-4 py-2 text-sm font-medium hover:text-blue-600">
                        {t("common:About Us")}
                      </a>
                    </Link>
                    ...
                    <Popover className="relative font-serif">
                      <Popover.Button className="group inline-flex items-center py-2 text-sm font-medium hover:text-blue-600 focus:outline-none">
                      ...
                      >
                        <Popover.Panel className="absolute z-10 -ml-1 mt-1 transform w-screen max-w-xs bg-white">
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 flex-grow w-full h-full">
                            <div className="relative grid gap-2 px-6 py-6">
                              {pages.map((item) => (
                                <span
                                  key={item.title}
                                  className="p-2 flex font-serif items-center rounded-md hover:bg-gray-50 w-full hover:text-blue-600"
                                >
                                  <item.icon
                                  ...
                                  />
                                  <Link href={item.href}>
                                    <a className="inline-flex items-center justify-between ml-2 text-sm font-medium w-full hover:text-blue-600">
                                      {t(`common:${item.title}`)}
                                    </a>
                                  </Link>
                                </span>
                    ...
                    <Link href="/offer">
                      <a className="relative inline-flex items-center h-6 bg-blue-400 font-serif ml-4 py-0 px-2 rounded text-sm font-medium text-white hover:text-blue-600">
                        {t("common:Offers")}
                        <div className="absolute flex w-2 h-2 left-auto -right-1 -top-1">
                          <span className="animate-ping absolute inline-flex h-2 w-2 rounded-full bg-blue-700 opacity-75"></span>

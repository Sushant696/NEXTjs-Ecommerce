            ...
            <div className="max-w-7xl mx-auto">
              <div className="flex justify-between items-center md:justify-start md:space-x-10">
                ...
                >
                  ...
                  <Link
                    href="/about-us"
                    className="font-serif mx-4 py-2 text-sm font-medium hover:text-blue-600">
                          ...
                          <div className="relative grid gap-2 px-6 py-6">
                            {pages.map((item) => (
                              ...
                              >
                                ...
                                <Link
                                  href={item.href}
                                  className="inline-flex items-center justify-between ml-2 text-sm font-medium w-full hover:text-blue-600">
                  ...
                  <Link
                    href="/offer"
                    className="relative inline-flex items-center h-6 bg-blue-400 font-serif ml-4 py-0 px-2 rounded text-sm font-medium text-white hover:text-blue-600">
